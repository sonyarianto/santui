...
To add capabilities to your dev setup, include them in the JSON object generated by your dev scripts (or manually edit `plugins.json`). See the radio stream player's manifest for a working example.
