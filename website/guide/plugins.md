...
| `crash_recovery` | If the plugin process crashes, the host shows a crash-recovery dialog with a restart option instead of removing the plugin from the palette. |
