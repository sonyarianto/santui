...
fn palette_commands() -> Vec<(String, String)> {
    vec![("Plugins".to_string(), "Kanban Board".to_string())]
}

fn key_hints() -> Vec<(String, String)> {
    vec![
        ("esc".to_string(), "close".to_string()),
        ("a".to_string(), "add card".to_string()),
        ("d".to_string(), "delete card".to_string()),
        ("m".to_string(), "move card".to_string()),
        ("c".to_string(), "add column".to_string()),
        ("e".to_string(), "edit card".to_string()),
    ]
}
